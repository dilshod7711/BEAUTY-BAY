...
const Shelf = () => {
    ...
    if (isLoading) {
        return (
            <div className="py-10 max-w-[1500px] mx-auto">
                <h2 className="text-3xl text-center font-bold mb-8">Flying off the shelves</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-4">
                    {[1, 2, 3, 4].map((index) => (
                        <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Skeleton.Image active className="w-[250px] h-[250px] object-cover mx-auto" />
                            <div className="p-4">
    ...
    return (
        <div className="py-10 max-w-[1500px] mx-auto mt-10">
            <h2 className="text-4xl text-center font-bold mb-16">Flying off the shelves</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-4">
                {data?.slice(73, 77).map((product: Product) => (
                    <div
                        key={product.id}
                        className="bg-white overflow-hidden relative border border-gray-150 rounded-lg transition duration-200 ease-in-out transform hover:scale-100 hover:shadow-xl"
                    >
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex justify-between items-center mt-4 text-center">
                                <button
                                    ...
                                    className="flex items-center justify-center bg-gray-800 text-white px-3 py-2 hover:bg-gray-700 transition w-full text-center mt-[-15px] rounded-lg"
                                >
